...
def boot_centos_container
  ...
  sh "docker exec centos /bin/bash -lc 'echo source /opt/rh/rh-ruby23/enable > /etc/profile.d/ruby-23.sh'"
  ...
  sh %(docker exec centos /bin/bash -lc 'ln -s -f /home/jdk-11/bin/java /usr/bin/java')

...
def boot_centos_container
  ...
  sh %(docker exec centos /bin/bash -ls 'curl https://download.java.net/openjdk/jdk11/ri/openjdk-11+28_linux-x64_bin.tar.gz -o /home/openjdk-11+28_linux-x64_bin.tar.gz')
  sh %(docker exec centos /bin/bash -ls 'tar -xvf /home/openjdk-11+28_linux-x64_bin.tar.gz -C /home/')
  sh %(docker exec centos /bin/bash -ls 'ln -s -f /home/jdk-11/bin/java /usr/bin/java')
end
